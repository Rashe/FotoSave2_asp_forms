        ...
        <div class="row-fluid">
            <div class="span3">
                <ul class="nav nav-list">
                    <li><a id="A1" href="~/Account/Profile.aspx" runat="server">Profile</a></li>
                    <li class="active"><a id="A2" href="~/Account/ChangePassword.aspx" runat="server">Password
                        </a></li>
                    <li><a href="#">Soon</a></li>
                    <li><a href="#">Soon</a></li>
                </ul>
                        ...
                        <div class="accountInfo">
                            ...
                            <p class="submitButton">
                                ...
                                <asp:Button ID="ChangePasswordPushButton" runat="server" CommandName="ChangePassword"
                                    Text="Change Password" ValidationGroup="ChangeUserPasswordValidationGroup" CssClass="btn" />
                            </p>
                        </div>
                    </ChangePasswordTemplate>
                </asp:ChangePassword>
